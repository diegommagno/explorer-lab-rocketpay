...
cardNumberMasked.on("accept", () => {
  const cardType = cardNumberMasked.masked.currentMask.cardtype // pegar o tipo do cartão de dentro da máscara sendo aplicada no momento. currentMask é a sendo utilizada no momento.
...
expirationDateMasked.on("accept", () => {
  updateExpirationDate(expirationDateMasked.value) // para pegar o valor validado pela mask.
})
